...
//        var continuation = workManager.beginWith(cleanupBuilder.build())
        ...
        val saveImageToFileBuilder = OneTimeWorkRequestBuilder<SaveImageToFileWorker>()
                .setConstraints(constraints)
                .addTag(TAG_OUTPUT)

        continuation = continuation.then(saveImageToFileBuilder.build())
     ...
     * Setters
     */
    internal fun setImageUri(uri: String?): Uri? {
